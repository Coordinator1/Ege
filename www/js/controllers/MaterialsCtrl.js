ege.controller('MaterialsCtrl', ['$scope', '$ionicScrollDelegate', 'filterFilter', '$location', '$anchorScroll', '$stateParams', 'HttpRequestService', function($scope, $ionicScrollDelegate, filterFilter, $location, $anchorScroll, $stateParams, HttpRequestService) {
  
  $scope.showLoading();

    HttpRequestService.getData('get_materials/' + $stateParams.topic_ID).then(function(ressponse) {
